...
from .views import message, create_salon, salon_list, get_messages_json, delete_salon,join_salon,exclude_member
...
urlpatterns = [
    ...
    path('salon/<int:salon_id>/exclude/<int:user_id>/',exclude_member,name="exclude_member"),
